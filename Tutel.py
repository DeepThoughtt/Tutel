...
class Tutel:
    ...
    def __init__(self):
        ...
        self.recursive_mode_check = tk.Checkbutton(self.data_frame, text = "Check subfolders too", variable = self.recvar, onvalue = 1, offvalue = 0, command = self.__check_recursive_mode)
        self.recursive_mode_check.pack()
